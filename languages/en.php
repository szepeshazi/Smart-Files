<?php
	...
	$english = array(
		...
		'smartfiles:admin:embedded_files:remove:filenotfound' =>	'Could not find the specified file',
		'smartfiles:admin:embedded_files:remove:success' =>	'Embedded file(s) was successfully removed from http://embedit.in',

		'smartfiles:select_all' => 'Select all',
		'smartfiles:deselect_all' => 'Deselect all',
		'smartfiles:refresh:embeds' => 'Refresh embeds for selected',
		'smartfiles:remove:embeds' => 'Remove selected embeds',
	
		'smartfiles:embed:refresh:info' => 'Preview doesn\'t look right?',
		'smartfiles:embed:refresh' => 'Generate preview again',
		'smartfiles:embed:disable' => 'Disable preview for this file',
		'smartfiles:embed:disable:confirm' => 'Are you sure you want to disable preview for this file? You can enable preview again later.',
		'smartfiles:embed:disabled:info' => 'Preview has been disabled for this file',
		'smartfiles:embed:enable' => 'Enable preview',

		'smartfiles:embed:refresh:success' => 'Preview has been successfully resfreshed for selected file(s)',
		'smartfiles:embed:disable:success' => 'Preview has been successfully disabled for selected file(s)',
		'smartfiles:embed:enable:success' => 'Preview has been successfully enabled for selected file(s)',
	
		'smartfiles:embed:refresh:bulk' => 'Generate',
		'smartfiles:embed:disable:bulk' => 'Disable',
		'smartfiles:embed:enable:bulk' => 'Enable',
